...
})(
	{
		1: [
			function (e, t, s) {
				...
				var c = "",
					...
					d = {
						...
						onCommand: function (e, t, s, n, i) {
							d.isDebug && console.log("onCommand default handler");
						},
						onChat: function (e, t, s, n, i) {
							d.isDebug && console.log("onChat default handler");
						},
						onWhisper: function (e, t, s, n, i) {
							d.isDebug && console.log("onWhisper default handler");
						},
						onMessageDeleted: function (e, t) {
							d.isDebug && console.log("onMessageDeleted default handler");
						},
						onJoin: function (e, t, s) {
							d.isDebug && console.log("onJoin default handler");
						},
						onPart: function (e, t, s) {
							d.isDebug && console.log("onPart default handler");
						},
						onHosted: function (e, t, s, n) {
							d.isDebug && console.log("onHosted default handler");
						},
						onRaid: function (e, t, s) {
							d.isDebug && console.log("onRaid default handler");
						},
						onSub: function (e, t, s, n) {
							d.isDebug && console.log("onSub default handler");
						},
						onResub: function (e, t, s, n, i, o) {
							d.isDebug && console.log("onResub default handler");
						},
						onSubGift: function (e, t, s, n, i, o) {
							d.isDebug && console.log("onSubGift default handler");
						},
						onSubMysteryGift: function (e, t, s, n, i) {
							d.isDebug && console.log("onSubMysteryGift default handler");
						},
						onGiftSubContinue: function (e, t, s) {
							d.isDebug && console.log("onGiftSubContinue default handler");
						},
						onCheer: function (e, t, s, n, i) {
							d.isDebug && console.log("onCheer default handler");
						},
						onChatMode: function (e, t) {
							d.isDebug && console.log("onChatMode default handler");
						},
						onReward: function (e, t, s, n, i) {
							d.isDebug && console.log("onReward default handler");
						},
						onConnected: function (e, t, s) {},
						onReconnect: function (e) {},
						Say: function (e, t) {
							return !!h && (t || (t = c), h.say(t, e).catch(d.onError), !0);
						},
						Whisper: function (e, t) {
							return !!h && (h.whisper(t, e).catch(d.onError), !0);
						},
						DeleteMessage: function (e, t) {
							return (
								!!h &&
								(t || (t = c), h.deletemessage(t, e).catch(d.onError), !0)
							);
						},
						GetClient: function () {
							return h;
						...
						Init: function (e, t, s, u) {
							...
							t && ((p.identity = { username: e, password: t }), (l = t)),
								(h = new n.client(p)).on("roomstate", function (e, t) {
									try {
										var s = e.replace("#", "");
										(d.chatModes[s] = d.chatModes[s] || {}),
											"emote-only" in t &&
												(d.chatModes[s].emoteOnly = t["emote-only"]),
											"followers-only" in t &&
												(d.chatModes[s].followerOnly =
													t["followers-only"] >= 0),
											"subs-only" in t &&
												(d.chatModes[s].subOnly = t["subs-only"]),
											"r9k" in t && (d.chatModes[s].r9kMode = t.r9k),
											"slow" in t && (d.chatModes[s].slowMode = t.slow),
											d.onChatMode(d.chatModes[s], s);
									} catch (e) {
										d.onError(e);
									}
								}),
								h.on("message", function (t, s, n, i) {
									try {
										...
										if (i || "!" !== n[0])
											"action" === k || "chat" === k
												? d.onChat(o, n, E, i, T)
												: "whisper" === k && d.onWhisper(o, n, E, i, T);
										else {
											var x = n.split(/ (.*)/),
												N = x[0].slice(1).toLowerCase(),
												D = x[1] || "";
											(T.sinceLastCommand = (function (e, t) {
								...
								h.on("reconnect", function () {
									console.log("Reconnecting"), f++, d.onReconnect(f);
								}),
								h.connect().catch(d.onError),
								t &&
									(async function e(t, s) {
										...
										(c =
											"undefined" != typeof window
												...
												: new o("wss://pubsub-edge.twitch.tv")),
											(c.onopen = function (e) {
				...
				void 0 !== t && t.exports && (t.exports = d),
					"undefined" != typeof window &&
						((window.ComfyJS = d), (n = window.tmi));
			},
								...
								function (e, t, s) {
									...
									t.exports = function (e, t) {
										...
										if (
											...
											n(i.merge({ method: "GET", json: !0 }, e, { url: s }), t);
										else if (i.isExtension()) {
											e = i.merge({ url: s, method: "GET", headers: {} }, e);
											...
											(o.responseType = "json"),
												o.addEventListener("load", function (e) {
													4 == o.readyState &&
														(200 != o.status
															? t(o.status, null, null)
															: t(null, null, o.response));
												}),
												o.send();
										} else {
											var a =
							...
							3: [
								function (e, s, n) {
									(function (t) {
										...
										for (var f in (h.inherits(m, o), (m.prototype.api = n), i))
											m.prototype[f] = i[f];
												...
												if (((e.tags = a.badges(a.emotes(e.tags))), e.tags))
													for (var o in e.tags)
														"emote-sets" !== o &&
															"ban-duration" !== o &&
															"bits" !== o &&
															(h.isBoolean(e.tags[o])
																? (e.tags[o] = null)
																: "1" === e.tags[o]
																? (e.tags[o] = !0)
																: "0" === e.tags[o] && (e.tags[o] = !1));
														...
														case "USERNOTICE":
															...
															switch (((N["message-type"] = i), i)) {
																...
																case "giftpaidupgrade":
																	...
																	this.emit("giftpaidupgrade", s, S, M, N);
																	break;
																...
																case "raid":
																	...
																	var R = e.tags["msg-param-viewerCount"];
																	this.emit("raided", s, S, R);
															}
															break;
														case "HOSTTARGET":
															var L = n.split(" ");
													...
													switch (e.command) {
														...
														case "PRIVMSG":
															if (
																...
																var W = h.username(n.split(" ")[0]),
																	z = n.includes("auto");
																if (n.includes("hosting you for")) {
																	var q = h.extractNumber(n);
																	this.emit("hosted", s, W, q, z);
																} else
																	n.includes("hosting you") &&
																		this.emit("hosted", s, W, 0, z);
															} else {
											...
											(m.prototype._sendMessage = function (e, t, s, n) {
												...
												return new Promise(function (o, r) {
													if (
														...
														2 === i.ws.readyState ||
														3 === i.ws.readyState ||
														h.isJustinfan(i.getUsername())
													)
														r("Not connected to server.");
													else {
														var c = h.channel(t);
														if (
															(i.userstate[c] || (i.userstate[c] = {}),
															s.length >= 500)
														) {
									...
									t.exports = {
										levenshtein: function (e, t, s) {
											...
											var a,
												...
												f = new Array(o + 1),
												d = new Array(o + 1);
											for (c = 0; o >= c; c++) f[c] = 1 * c;
											for (a = 0; i > a; a++) {
												for (d[0] = f[0] + 1, c = 0; o > c; c++)
													(l = f[c] + (e[a] == t[c] ? 0 : 1)) >
														(u = f[c + 1] + 1) && (l = u),
														l > (h = d[c] + 1) && (l = h),
														(d[c + 1] = l);
											...
											a = (t.exports = {
												...
												union: function (e, t) {
													for (var s = {}, n = [], i = 0; i < e.length; i++) {
														s[(o = e[i])] || ((s[o] = !0), n.push(o));
													}
													for (i = 0; i < t.length; i++) {
														var o;
														s[(o = t[i])] || ((s[o] = !0), n.push(o));
													}
													return n;
												},
												username: function (e) {
									...
									(m.nextTick = function (e) {
										...
										if (arguments.length > 1)
											for (var s = 1; s < arguments.length; s++)
												t[s - 1] = arguments[s];
										d.push(new c(e, t)), 1 !== d.length || p || o(a);
									}),
